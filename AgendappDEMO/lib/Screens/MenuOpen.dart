...
final List<Talk> _talkList = [
  new Talk(new DateTime(2019, 12, 8, 8, 0), new DateTime(2019, 12, 8, 9, 30), "Drones and food delivery: A marriage made in Heaven", "There are so many food delivery unicorns, but could getting your food delivery be bad for the planet?", "Room 101", false, [speakers[0], speakers[3]], [allThemes[0]]),
  new Talk(new DateTime(2019, 12, 8, 12, 0), new DateTime(2019, 12, 8, 13, 0),
      ...
      "Room 102", true, [speakers[1]], [allThemes[1], allThemes[2], allThemes[3]]),
  new Talk(new DateTime(2019, 12, 8, 14, 0), new DateTime(2019, 12, 8, 15, 0),
      ...
      "Room 103", false, [speakers[3], speakers[4]], allThemes),
  new Talk(new DateTime(2019, 12, 8, 16, 0), new DateTime(2019, 12, 8, 17, 0),
      ...
      "Room 104", false, [speakers[2]], [allThemes[2]]),
  new Talk(new DateTime(2019, 12, 10, 9, 0), new DateTime(2019, 12, 10, 10, 0),
      ...
      "Room 105", true,[speakers[3]], [allThemes[3]]),
  new Talk(new DateTime(2019, 12, 10, 16, 0), new DateTime(2019, 12, 10, 17, 30),
      ...
      "Room 106", false, [speakers[0]], [allThemes[0]]),
];
